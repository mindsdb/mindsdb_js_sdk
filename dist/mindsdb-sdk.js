...
var Predictor = function Predictor(_data) {
      ...
      return regenerator.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              mergeParams = params ? [].concat(toConsumableArray(params), [connection.token]) : [connection.token];
              request = setQueryParams(mergeParams, "/predictors/".concat(params.oldName, "/renmame?new_name=").concat(params.newName));
              _context5.next = 4;
              return connection.api.get(request);
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator.mark(function _callee8(when, params) {
      var mergeParams, request, response;
